package com.luanpaiva.invoice_service.adapters.out.jwt;

import com.auth0.jwt.JWT;
import com.auth0.jwt.algorithms.Algorithm;
import com.auth0.jwt.exceptions.TokenExpiredException;
import com.auth0.jwt.interfaces.DecodedJWT;
import com.luanpaiva.invoice_service.adapters.out.jwt.response.BearerToken;
import com.luanpaiva.invoice_service.config.properties.AuthServiceProperties;
import com.luanpaiva.invoice_service.config.properties.InvoiceServiceProperties;
...
public class AuthService implements AuthServicePort {
    ...
    private final InvoiceServiceProperties invoiceServiceProperties;
    ...
    public String getInternalToken(String key) {
        try {
            ...
            if (isNull(accessToken)) {
                ...
                String clientId = invoiceServiceProperties.getClientId();
                String clientSecret = invoiceServiceProperties.getClientSecret();
